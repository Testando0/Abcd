...
/** ✅ NOVA FUNÇÃO (era isso que o SearchOverlay estava chamando) */
export function getDriveId(tmdbId) {
  const item = getContentByTmdbId(tmdbId);
  return item ? extractDriveFileId(item.driveLink) : null;
}
